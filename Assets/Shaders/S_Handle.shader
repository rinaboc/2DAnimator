...
// Original shader code by nubick
...
Shader "Sprites/Clipped"
{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			{
                if (IN.worldPos.x < _TopLeftAnchor.x || IN.worldPos.y > _TopLeftAnchor.y ||
                    IN.worldPos.x > _BottomRightAnchor.x || IN.worldPos.y < _BottomRightAnchor.y) {
                        discard;
                }
